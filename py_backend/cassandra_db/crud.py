...
class Operations:
    ...
    def __init__(self, logger):
        ...
        try:
            self.lg = logger
            cloud_config = {'secure_connect_bundle': r'py_backend/cassandra_db/secure-connect-ineuron.zip'}
            ...
            logging.getLogger('cassandra.io.asyncorereactor').setLevel(logging.ERROR)
